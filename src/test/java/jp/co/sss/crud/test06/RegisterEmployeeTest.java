...
public class RegisterEmployeeTest {
	...
	public void 正常系_社員登録操作_登録完了() {
		...
		//プルダウン
		Select select = new Select(webDriver.findElement(By.cssSelector(".update select[name='departmentForm.deptId']")));
...
//				.findElement(By.cssSelector("table tr:nth-of-type(5) td:nth-of-type(8) input[type='submit']"));
				.findElement(By.cssSelector("table tr:nth-of-type(5) td:nth-of-type(8) button"));
		WebElement buttonDelete = webDriver
//				.findElement(By.cssSelector("table tr:nth-of-type(5) td:nth-of-type(9) input[type='submit']"));
				.findElement(By.cssSelector("table tr:nth-of-type(5) td:nth-of-type(9) button"));
		...
		assertEquals("変更", buttonUpdate.getText());//.getAttribute("value"));
		assertEquals("削除", buttonDelete.getText());//.getAttribute("value"));
